...
const Breadcrumbs = () => <div className="w3l-breadcrumbs">
...
const Contacts = () => <section className="w3l-contact-1">
...
const SearchPopup = () => <div id="search" className="pop-overlay">
            <div className="popup">
...
const SearchRight = () => <div className="search-right">
...
const Navigation = () => <nav className="navbar navbar-expand-lg navbar-light fill px-lg-0 py-0 px-3">
        <div className="container">
            <h1><a className="navbar-brand" href="index.html"><span className="fa fa-play icon-log" aria-hidden="true"></span>
                ProShowz </a></h1>
            ...
            <div className="collapse navbar-collapse" id="navbarSupportedContent">
                <ul className="navbar-nav ml-auto">
                    ...
                    <li className="nav-item">
                        <a className="nav-link" href="genre.html">Genre</a>
                    </li>
                                ...
                                <div className="right-side">
                                    <div className="row footer-about">
                                        <div className="col-md-3 col-6 footer-img mb-lg-0 mb-4">
                                            <a href="articles.html"><img className="img-fluid" src="assets/images/banner1.jpg" alt=""/></a>
                                        </div>
                                        <div className="col-md-3 col-6 footer-img mb-lg-0 mb-4">
                                            <a href="articles.html"><img className="img-fluid" src="assets/images/banner2.jpg" alt=""/></a>
                                        </div>
                                        <div className="col-md-3 col-6 footer-img mb-lg-0 mb-4">
                                            <a href="articles.html"><img className="img-fluid" src="assets/images/banner3.jpg" alt=""/></a>
                                        </div>
                                        <div className="col-md-3 col-6 footer-img mb-lg-0 mb-4">
                                            <a href="articles.html"><img className="img-fluid" src="assets/images/banner4.jpg" alt=""/></a>
                                        </div>
                                    </div>
